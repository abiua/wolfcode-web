...
<#--                               class="layui-input">-->
                        <select name="sex">
                            <option <#if obj.sex=="1">selected</#if> value="1">
                                男
                            </option>
                            <option <#if obj.sex=="0">selected</#if> value="0">
                                女
                            </option>
                        </select>
                    </div>
...
<script type="text/javascript" src="${request.contextPath}/scripts/custLinkMan/custLinkManInfo/update.js?_=${randomNum}"></script>
</body>
