...
<#--                    <div class="layui-input-block">-->
<#--&lt;#&ndash;                        <input type="text"  name="custId"  placeholder="请输入"  autocomplete="off" class="layui-input">&ndash;&gt;-->
<#--                        -->
<#--                    </div>-->
                    <select name="custId">
...
<script type="text/javascript" src="${request.contextPath}/scripts/custLinkMan/custLinkManInfo/add.js?_=${randomNum}"></script>
</body>
