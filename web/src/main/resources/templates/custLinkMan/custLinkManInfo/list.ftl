    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="custLinkMan:custLinkManInfo:list">
                    ...
                    <form class="layui-form layui-card-header layuiadmin-card-header-auto"
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">联系人||手机号||</label>
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="custLinkMan:custLinkManInfo:add">
                                <button class="layui-btn layui-btn-sm layui-btn-primary"
                                        lay-event="add"><i class="layui-icon">&#xe654;</i>新增
                                </button>
                            </@sec.authenticate>

<#--                            <@sec.authenticate grants="custLinkMan:custLinkManInfo:export">-->
...
<#--                            </@sec.authenticate>-->
                    ...
                    <script type="text/html" id="List-editBar">
                        <@sec.authenticate grants="custLinkMan:custLinkManInfo:update">
                            <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="update"><i
                                        class="layui-icon">&#xe642;</i>修改</a>
                        </@sec.authenticate>
                        <@sec.authenticate grants="custLinkMan:custLinkManInfo:delete">
...
<script type="text/javascript" src="${request.contextPath}/scripts/custLinkMan/custLinkManInfo/list.js?_=${randomNum}"></script>
</body>
</html>
