...
<#--                               class="layui-input">-->
                        <select name="openStatus">
                            <option <#if obj.openStatus == 0>selected</#if> value="0">
                                开业
                            </option>
                            <option <#if obj.openStatus == 1>selected</#if> value="1">
                                注销
                            </option>
                            <option <#if obj.openStatus == 2>selected</#if> value="2">
                                破产
                            </option>
                        </select>
                    </div>
...
<#--                               class="layui-input">-->
                        <select name="province">
                            <#list citys as city>
                                <#if obj.province == "${city.key}"><option selected value="${city.key}">${city.value}</option>
                                <#else>
