...
<div class="layui-col-md12">
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="text-align: center">
            ...
            <p style="color: orange;text-align: left"><i class="layui-icon">&#xe702;</i>必填信息:xxx</p>
        </div>
    </div>
</div>
<div class="layui-col-md12">
...
<script type="text/javascript" src="${request.contextPath}/static/scripts/custContract/custContractInfo/importCustContract.js?_=${randomNum}"></script>
</body>