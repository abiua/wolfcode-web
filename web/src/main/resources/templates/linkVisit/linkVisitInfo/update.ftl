...
<#--                               class="layui-input">-->
                        <select name="custId">
                            <#list customerList as clist>
                                <#if obj.custId==clist.id>
                                    <option selected value="${clist.id}">${clist.customerName}</option>
                                <#else>
...
<#--                               class="layui-input">-->
                        <select name="linkmanId">
                            <#list linkmanList as llist>
                                <#if obj.linkmanId==llist.id>
                                    <option selected value="${llist.id}">${llist.linkman}</option>
                                <#else>
...
<#--                               class="layui-input">-->
                        <select name="visitType">
                            <option <#if obj.visitType=="1">selected</#if> value="1">
                                上门走访
                            </option>
                            <option <#if obj.visitType=="2">selected</#if> value="2">
                                电话拜访
                            </option>
                        </select>
                    </div>
...
<script type="text/javascript" src="${request.contextPath}/scripts/linkVisit/linkVisitInfo/update.js?_=${randomNum}"></script>
</body>
